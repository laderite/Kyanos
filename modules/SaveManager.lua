...
do
    SaveManager.Folder = "KyanosSettings"
    SaveManager.Ignore = {}
    SaveManager.Parser = {
        Toggle = {
    ...
    function SaveManager:BuildConfigSection(tab)
        ...
        -- Current Status
        local ConfigStatus = section:AddText({
            Title = "Status",
            Description = "No config is currently loaded",
        })

        local AutoloadStatus = section:AddText({
            Title = "Autoload",
        ...
        section:AddButton({
            ...
            Callback = function()
                ...
                self.Library:Notify({
                    Title = "Interface",
                    Content = "Config loader",
                    SubContent = string.format("Updated config %q", name),
                    Duration = 7,
                })
            end,
        })
        ...
        section:AddButton({
            Title = "Set Autoload",
            Description = "Load this config automatically on startup",
            Style = "default",
            Callback = function()
                local name = SaveManager.Options.SaveManager_ConfigList.Value
