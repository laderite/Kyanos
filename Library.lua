...
local ClosureBindings = {
        ...
        return (function(...)
            ...
            function Element:New(Idx, props)
                local Colorpicker = {
                    ...
                    Value = props.Default or Color3.fromRGB(255, 255, 255),
                    Type = 'Colorpicker',
                    ...
                    if Colorpicker.Opened:get() then
                        local escapeConnection = UserInputService.InputBegan:Connect(function(
                            ...
                            if Input.KeyCode == Enum.KeyCode.Escape then
                                Colorpicker.Opened:set(false)
                            end
                        end)

                        table.insert(Colorpicker.Connections, escapeConnection)
                        ...
                        table.insert(Colorpicker.Connections, positionConnection)
                        RecalculatePickerPosition()
                    else
                        for _, connection in pairs(Colorpicker.Connections)do
                ...
                function Colorpicker:Display()
                    ...
                    unwrap(Visualize).BackgroundColor3 = color
                ...
                unwrap(Submit).BackgroundColor3 = Colorpicker.Value
        ...
        return (function(...)
            ...
            function Element:New(Idx, props)
                ...
                if type(props.Default) == 'string' then
                    local Idxa = table.find(Dropdown.Values, props.Default)

                    if Idxa then
                        table.insert(Defaults, Idxa)
                    end
                elseif type(props.Default) == 'table' then
                    for _, Value in next, props.Default do
                        local Idxa = table.find(Dropdown.Values, Value)
        ...
        return (function(...)
            ...
            function Module:New(Config)
                ...
                local backgroundTransparency = Computed(function()
                    return if not isVisible:get()
                        then 1
                        elseif isHovered:get()
                        then 0.1
                        else 0
                end)
                ...
                local destroyNotification = function()
    ...
    [23] = function()
        local wax, script, require = ImportGlobals(23)
        ...
        return (function(...)
            ...
            return function(props)
                ...
                table.insert(unwrap(States.Library).Connections, UserInputService.InputChanged:Connect(function(
                    input
                )
                    if (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) and Resizing:get() then
                        ...
                        local TargetSizeClamped = Vector2.new(math.clamp(TargetSize.X, 600, 2048), math.clamp(TargetSize.Y, 400, 2048))
                ...
                table.insert(unwrap(States.Library).Connections, UserInputService.InputEnded:Connect(function(
                    input
                )
                    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
...
[['%s' isn't a valid stage for a special key to be applied at.]],
    ...
    [81] = function()
        local wax, script, require = ImportGlobals(81)
    ...
    [84] = function()
        local wax, script, require = ImportGlobals(84)
...
[[[SnapdragonController] This object is already bound to a controller]])
    ...
    [89] = function()
        local wax, script, require = ImportGlobals(89)
    ...
    [92] = function()
        local wax, script, require = ImportGlobals(92)
...
[[Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse mollis dolor eget erat mattis, id mollis mauris cursus. Proin ornare sollicitudin odio, id posuere diam luctus id.]],
    ...
    [95] = function()
        local wax, script, require = ImportGlobals(95)
    ...
    [97] = function()
        local wax, script, require = ImportGlobals(97)
